package com.alten.testsigma.addons.ios.test;
...
import com.alten.testsigma.addons.ios.EnterDataIfVisible;
...
public class newTestTapOnRelative {
    ...
    public void setup() throws Exception {
        ...
        capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, "15.7.6");
        capabilities.setCapability(MobileCapabilityType.PLATFORM_NAME, "iOS");
        capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "XCUITest");
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iPhone Test");

        capabilities.setCapability("app", "C:\\NexiPay\\NexiPayIos_7_10_0_6.ipa");
