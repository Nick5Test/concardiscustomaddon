...
@Data
@Action(actionText = "2_Unsubscribe ACS and SMS inserting: pan, phoneNumber, panAlias", applicationType = ApplicationType.IOS)
public class v2_UnsubscribeSMS_ACS extends IOSAction {
